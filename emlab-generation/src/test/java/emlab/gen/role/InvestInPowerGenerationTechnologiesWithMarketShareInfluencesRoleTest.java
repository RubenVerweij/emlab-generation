...
@Transactional
public class InvestInPowerGenerationTechnologiesWithMarketShareInfluencesRoleTest {

    Logger logger = Logger.getLogger(InvestInPowerGenerationTechnologiesWithMarketShareInfluencesRoleTest.class);
