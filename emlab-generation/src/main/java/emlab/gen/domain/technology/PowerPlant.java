...
public class PowerPlant {
     ...
     * reads the investment cost from the and automatically adjusts for the
     * actual building and permit time, as well as power plant size.
     * 
     * @param timeOfPermitorBuildingStart
     */
    /*
     * public void calculateAndSetActualInvestedCapital( long
     * timeOfPermitorBuildingStart) {
     * setActualInvestedCapital(this.getTechnology().getInvestmentCost(
     * timeOfPermitorBuildingStart + getActualLeadtime() +
     * getActualPermittime()) getActualNominalCapacity()); }
     */
